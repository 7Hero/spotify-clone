...
import { DesktopComputerIcon, PlayIcon, PauseIcon, ArrowCircleRightIcon, ArrowCircleLeftIcon } from '@heroicons/react/solid'
      ...
      <div className="w-full absolute bottom-0 h-24 px-4 bg-[rgb(18,18,18)] flex items-center justify-center  border-t border-solid border-[rgb(40,40,40)]">
        ...
        <div className="flex flex-col items-center w-[40%]">
          <div className='space-x-3 flex items-center'>
            <button className="text-white transition duration-150 hover:scale-110" onClick={ () => player.previousTrack() }> <ArrowCircleLeftIcon className="h-6 w-6"/> </button>
            <button className="text-white transition duration-150 hover:scale-110" onClick={ () => player.togglePlay() }> { is_paused ? <PlayIcon className="h-10 w-10"/> : <PauseIcon className="h-10 w-10"/>} </button>
            <button className="text-white transition duration-150 hover:scale-110" onClick={ () => player.nextTrack() }> <ArrowCircleRightIcon className="h-6 w-6"/> </button>
          </div>
        ...
        <div className='w-[30%] flex justify-end'>
         ...
         <button className="text-white" onClick={ () => transferPlayback(deviceId) }> <DesktopComputerIcon className="h-5 w-5"/> </button>
        </div>
